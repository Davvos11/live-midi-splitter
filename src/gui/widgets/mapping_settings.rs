use eframe::emath;
use egui::{Button, Color32, ComboBox, DragValue, RichText, Slider, TextStyle, Ui};
...
pub fn mapping_settings(ui: &mut Ui, output_settings: &mut OutputSettings, input_id: usize, tab_state: &mut TabState) {
    ...
    let collapse = header.show_header(ui, |ui| {
        ...
        ui.selectable_value(current_tab, Tab::NoteFilter, RichText::new("Notes").text_style(TextStyle::Small));
        ...
        match current_tab {
            ...
            Tab::NoteFilter => {
                ...
                let channel_map = &mut output_settings.channel_map;
